...
public class ConditionalComparison extends LanguageComparisonHome {
    ...
    protected void initializeText(String initialLanguage, String contextLanguage) {
        ...
        String titleFormat = getResources().getString(R.string.conditionals_title);
        ...
        if (!initialLanguage.equals(contextLanguage)) {
            subtitleFormat = getResources().getString(R.string.conditionals_subtitle1);
            subtitleText = String.format(subtitleFormat, initialLanguage, contextLanguage);
        } else {
            subtitleFormat = getResources().getString(R.string.concepts_no_context_subtitle1);
        ...
        switch(initialLanguage) {
            case "Java":
                initialContent1.setImageResource(R.drawable.java_if);
                break;
            case "C":
                initialContent1.setImageResource(R.drawable.c_if);
                break;
            case "C++":
                initialContent1.setImageResource(R.drawable.cplus_if);
                break;
            case "Python":
                initialContent1.setImageResource(R.drawable.python_if);
                break;
            case "Swift":
                initialContent1.setImageResource(R.drawable.swift_if);
                break;
        }
        ...
        if (!contextLanguage.equals(initialLanguage))
            switch(contextLanguage) {
                case "Java":
                    contextContent1.setImageResource(R.drawable.java_if);
                    break;
                case "C":
                    contextContent1.setImageResource(R.drawable.c_if);
                    break;
                case "C++":
                    contextContent1.setImageResource(R.drawable.cplus_if);
                    break;
                case "Python":
                    contextContent1.setImageResource(R.drawable.python_if);
                    break;
                case "Swift":
                    contextContent1.setImageResource(R.drawable.swift_if);
                    break;
            }
        else {
